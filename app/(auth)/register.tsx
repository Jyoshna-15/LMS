...
//                 <View style={[styles.strengthDot, password.length >= 6 ? styles.strengthDotActive : null]} />
//                 <View style={[styles.strengthDot, /[A-Z]/.test(password) ? styles.strengthDotActive : null]} />
//                 <View style={[styles.strengthDot, /[0-9]/.test(password) ? styles.strengthDotActive : null]} />
